...
def main(lev, goal_epoch):
    model_ckp = config.model.ckp_path_bot + config.model.ckp_lev_scale + lev + '/gray/'
    ...
    with tf.device('/device:GPU:1'):
        with tf.Graph().as_default():
            with tf.Session(config=tf.ConfigProto(log_device_placement=True)) as sess:
                ...
                train_op = tf.train.AdamOptimizer(1e-5).minimize(loss, global_step=global_step,
                ...
                while True:
                    ...
                    if step % 70 == 0:
                        ...
                        """
                        path = '/home/ict419/PycharmProjects/AVSSlapnet/evaluation/result/lev_scale_4/bot_inter/'
                        result = 0
